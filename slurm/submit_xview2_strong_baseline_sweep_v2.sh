...
CONFIG="${1:-configs/xview2_strong_baseline_sweep_v2.csv}"
RUNNER="${RUNNER:-slurm/run_xview2_strong_baseline_v2_config.sh}"
...
echo "Submitting xView2 strong-baseline-inspired v2 sweep from ${CONFIG}"
echo "Runner: ${RUNNER}"
...
echo "Submitted ${submitted} xView2 strong-baseline v2 jobs. Skipped ${skipped} disabled/planned rows."
