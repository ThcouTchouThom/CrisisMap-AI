...
CONFIG="${1:-configs/multitemporal_fusion_sweep_v2.csv}"
RUNNER="${RUNNER:-slurm/run_multitemporal_fusion_v2_config.sh}"
...
echo "Submitting Multi-Temporal Fusion v2 sweep from ${CONFIG}"
echo "Runner: ${RUNNER}"
...
echo "Submitted ${submitted} Multi-Temporal Fusion v2 jobs. Skipped ${skipped} disabled/planned rows."
