...
CONFIG_CSV="${CONFIG_CSV:-configs/damage_arch_sweep_v2.csv}"
FORCE="${FORCE:-0}"
...
echo "Submitting Axis 2 damage architecture v2 sweep independently."
...
do
  ...
  job_name="dmg_arch_v2_${experiment:0:56}"
...
echo
echo "Submitted Axis 2 damage architecture v2 rows."
