...
CONFIG="${1:-configs/xview2_strong_baseline_sweep_v1.csv}"
RUNNER="${RUNNER:-slurm/run_xview2_strong_baseline_config.sh}"
...
echo "Submitting xView2 strong-baseline-inspired sweep from ${CONFIG}"
echo "Runner: ${RUNNER}"
...
echo "Submitted ${submitted} xView2 strong-baseline-inspired jobs."
